...
class SimpleBrowserHistory
{
    ...
    {
        $this->_dropFuture();
        $this->_sequence[] = ['url' => $url, 'parameters' => $parameters];
        $this->_position++;
    }
...
class SimpleBrowser
{
    ...
    public $_page;
    public $_history;
    public $_ignore_frames = false;
    public $_maximum_nested_frames = DEFAULT_MAX_NESTED_FRAMES;
     ...
     *    @access protected
     */
    public function _createHistory()
    {
     ...
     *    @access private
     */
    public function _parse($response, $depth = 0)
    {
     ...
     *    @access protected
     */
    public function _buildPage($response)
    {
     ...
     *    @access private
     */
    public function _fetch($url, $encoding, $depth = 0)
    {
     ...
     *    @access private
     */
    public function _load($url, $parameters)
    {
        $frame = $url->getTarget();
     ...
     *    @access private
     */
    public function _loadPage($url, $parameters)
    {
     ...
     *    @access private
     */
    public function _loadFrame($frames, $url, $parameters)
    {
