...
class CallMap
{
     ...
     */
    public function addValue($parameters, $value)
    {
     ...
     */
    public function addReference($parameters, &$reference)
    {
     ...
     *                                slot, otherwise null.
     */
    public function findFirstMatch($parameters)
    {
...
class SimpleMock
{
    ...
    {
        if (! is_array($args)) {
            throw new \InvalidArgumentException("Cannot $task as \$args parameter is not an array");
        }
    }
    ...
    public function _dieOnNoMethod($method, $task)
    {
        if ($this->_is_strict && ! method_exists($this, $method)) {
            throw new \InvalidArgumentException("Cannot $task as no {$method}() in class " . static::class);
        }
    }
     ...
     *    @access protected
     */
    public function _getReturn($method, $args, $step)
    {
