...
class SimplePage
{
    ...
    public $_frameset = false;
    public $_frames = [];
    public $_frameset_nesting_level = 0;
    ...
    public function getFrameset()
    {
        ...
        for ($i = 0; $i < count($this->_frames); $i++) {
            ...
            $urls[$name ?: $i + 1] = $url->makeAbsolute($this->getUrl());
        }
        return $urls;
    }
     ...
     *    @access protected
     */
    public function _makeAbsolute($url)
    {
        if (! is_object($url)) {
